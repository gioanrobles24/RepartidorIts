        ...
        return (
            <Router  navBarButtonColor='#a9d046'>
                <Stack key="root">
                    ...
                    <Scene key="CurrentsOrdersView" hideNavBar={false} component={CurrentOrderView}/>
                    <Scene key="CurrentsOrdersDetailView" hideNavBar={false} component={CurrentsOrdersDetailView}/>
                    <Scene key="deliverRate" hideNavBar={false} component={RepartidorRateView}/>
                </Stack>
            </Router>
        )
    }
