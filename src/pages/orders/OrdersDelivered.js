 ...
 constructor(props) {
          ...
          this.state = {
            ...
            let dm_id = this.props.dm_id
              ...
              fetch('http://test.itsontheway.com.ve/api/delivery/orders_delivered/'+dm_id, {
                  method: 'GET',
                  headers: {
                          ...
                          <TouchableHighlight
                           ...
                           >
                                <Card style={styles.cardOrder} >
                                      <Text style={styles.cardOrderSubTitle}>Orden #:{Object.id}</Text>
          ...
          <Card style={styles.cardOrder}>
              ...
              />
                <Text style={styles.cardOrderSubTitle}
                 h3 onPress={newScreen}>Nombre pedido
                 </Text>
                <Badge containerStyle={{ alignSelf: 'center', marginLeft: 30}}
                 value="Entregado" onPress={newScreen} status="success"
                />
           </Card>
       </View>
    </View>
