       ...
       this.state = {
         ...
         let dm_id = this.props.dm_id
            console.log ('ird dm_id'+dm_id)
                    fetch('http://test.itsontheway.com.ve/api/delivery/current_orders/'+dm_id, {
                  method: 'GET',
                  headers: {
                          ...
                          <TouchableHighlight
                            ...
                            onPress={() =>   {
                                ...
                                <Card style={styles.cardOrder} >
                                      <Text style={styles.cardOrderSubTitle}  h3>Orden #:{Object.id}</Text>
                                        <Badge containerStyle={styles.cardBadge}  value="Disponible" status="primary" />
                                </Card>
                            </TouchableHighlight>)}
                    </ScrollView>
                </View>
